    ...
    <view class="form">
      ...
      <view class="form-content">
        <view class="form-item">
          ...
          <text class="account placeholder">{{ profile&&'testdev' }}</text>
        </view>
        <view class="form-item">
        ...
        <view class="form-item">
          ...
          <radio-group @change="onGenderChange">
            <label class="radio">
              <radio value="男" color="#e9cfa8" :checked="profile?.gender === '男'" />
              男
            </label>
            <label class="radio">
              <radio value="女" color="#e9cfa8" :checked="profile?.gender === '女'" />
              女
            </label>
          </radio-group>
        </view>
...
.viewport {
  ...
  background-image: linear-gradient(-49deg, #e0c8a4 0%, #dec3b0 100%);
